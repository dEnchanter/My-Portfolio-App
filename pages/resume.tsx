...
export default function Resume() {
  ...
  return (
    <>
      <Head>
        <title>Afolabi Opaleye - Resume</title>
      </Head>

      <div className="min-h-screen bg-[rgb(36,36,36)] py-10">
        {/* Back to Portfolio Link & Print Button */}
        <div className="max-w-4xl mx-auto px-8 mb-6 flex justify-between items-center no-print">
          <Link href="/">
            <motion.button
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.5 }}
              className="bg-[#F7AB0A] text-black px-6 py-3 rounded-md font-semibold hover:bg-[#F7AB0A]/80 transition-all"
            >
              ← Back to Portfolio
            </motion.button>
          </Link>
        ...
        <motion.div
          ...
          className="resume-container max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-2xl"
        >
          {/* Header */}
